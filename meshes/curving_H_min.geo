...
Point(11) = { -dx*0.4 , y_crack, 0.0, ref_gridsize};
Point(12) = {  dx*0.4, y_crack, 0.0, ref_gridsize};
...
Point(17) = {  offx*3.25 + adhocx , y_crack + dy_crack, 0.0, ref_gridsize};
Point(18) = { -(offx*3.25 + adhocx) , y_crack + dy_crack, 0.0, ref_gridsize};
//
Line(1) = {1,2};
Line(2) = {2,3};
Line(3) = {3,4};
